...
if (isset($_POST['hint_id'])) {
	$qstring='UPDATE `khan_exercises`.`khan_hint` SET `hint_question`=\''. $_SESSION['question_id'] .'\', `hint_text`=\''. $_POST['new_hint_text'] .'\', `hint_order`=\''. $_POST['hint_order'] .'\' WHERE `hint_id`=\''.$_POST['hint_id'].'\'';
} else {
