	...
	$
			.widget(
					'ui.multiAccordion',
					{
						...
						_create : function() {
							...
							$h3
									.each(function(index) {
										var $this = $(this);
										$this
												.addClass(options._classes.h3)
												/*.prepend(
														'<span class="{class}"></span>'
																.replace(
																		/{class}/,
																		options._classes.span));
										*/
											...
											function(e) {
												...
												self
														._trigger('click',
																null, ui);
												if ($this
														.hasClass(options._classes.stateDefault)) {
													self._showTab($this);
												} else {
													self._hideTab($this);
												}
						...
						// helper method to determine wether passed parameter is
						// an index of an active tab or not
						...
						// active option passed by plugin, this method will read
						// it and convert it into array of tab indexes
						...
						// required method by jquery ui widget framework, used
						// to provide the ability to pass options
						// currently only active option is used here, may grow
						// in the future
						_setOption : function(option, value) {
							...
							case 'active':
								this._setActiveTabs(this
										._generateTabsArrayFromOptions(value));
								break;
							case 'getActiveTabs':
								var el = this.element;
								var tabs;
